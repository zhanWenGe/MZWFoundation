...
+ (NSDate *)getDateWithTimeSting:(NSString *)timeString {
...
+ (NSString *)getTheDayOfTheWeekByDateString:(NSString *)dateString fromFormat:(NSString *)fromFormate toFormat:(NSString *)toFormat{
    
    NSDateFormatter *inputFormatter = [[NSDateFormatter alloc] init];
    
    [inputFormatter setDateFormat:fromFormate];
    ...
    [outputFormatter setDateFormat:toFormat];
